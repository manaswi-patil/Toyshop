    ...
    <footer className="bg-gray-900 text-white py-12 px-4 sm:px-6 lg:px-8">
      <div className="max-w-7xl mx-auto">
        <div className="grid md:grid-cols-4 gap-8 mb-8">
          ...
          <div>
            <div className="flex items-center space-x-2 mb-4">
              ...
              <span className="text-xl font-bold">ToyShop</span>
            </div>
            <p className="text-gray-400 mb-4">
              Bringing joy and wonder to children everywhere with our amazing
              collection of toys.
            </p>
          ...
          <div>
            ...
            <form className="space-y-2">
              ...
              <button
                type="submit"
                className="w-full bg-gradient-to-r from-pink-500 to-purple-600 text-white py-2 rounded-lg font-semibold hover:shadow-lg transition-all duration-200"
              >
                Subscribe
              </button>
            </form>
        ...
        <div className="border-t border-gray-800 pt-8 text-center text-gray-400">
          <p>&copy; 2024 ToyShop. All rights reserved.</p>
        </div>
      </div>
    </footer>
  );
